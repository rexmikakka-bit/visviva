...
Before changing user-facing UI, read [docs/ui-conventions.md](docs/ui-conventions.md).
Name the existing Axis screen/component you will follow, reuse its components and
interaction patterns, and compare the result with that reference in the running app.
Matching theme colors or passing `npm run verify` does not establish visual consistency.
